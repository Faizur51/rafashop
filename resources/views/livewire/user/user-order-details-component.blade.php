                ...
                <div class="d-flex justify-content-between align-items-center">
                   ...
                   <div class="d-flex ">
                       @if($order->status=="ordered")
                           <a href="" wire:click.prevent="cancelOrder" class="btn btn-success btn-sm">Cancel My Order</a>
                       @endif
                           <a href="{{route('user.dashboard')}}" class="btn btn-success btn-sm ml-5">Order list</a>
                   </div>
                </div>
            </div>
                                ...
                                <table class="table bg-light">
                                    ...
                                    @foreach($order->orderItems as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">{{ucwords($item->product->name)}}</a>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('user.review',['order_item_id'=>$item->id])}}"><i class="fi-rs-edit" style="font-size:18px;margin-right: 5px"></i> Write Review</a>
                                                @endif
                                            </td>
                                    ...
                                    <tr>
                                        <th>Subtotal</th>
                                        <td class="product-subtotal" colspan="3">&#2547; {{round($order->subtotal)}}</td>
                                    </tr>
                                    <tr>
                                        <th>Tax({{config('cart.tax')}}%)</th>
                                        <td class="product-subtotal" colspan="3">&#2547; {{round($order->tax)}}</td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                                        <td colspan="3" class="product-subtotal"><span class="font-xl text-brand fw-900">&#2547; {{round($order->total)}}</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
